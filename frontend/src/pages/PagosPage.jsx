...
export default function PagosPage() {
  ...
  const guardar = async () => {
    try {
      const payload = {
        ...form,
        fechaPago: formatLocalDate(form.fechaPago),
      };
    ...
    <div>
      ...
      <div className="page-header mb-3">
        <div>
          ...
          <p className="page-subtitle m-0">Registro simple de cobros y consultas rápidas.</p>
        </div>
      ...
      <Dialog visible={dialog} onHide={() => setDialog(false)}
        header="Registrar pago" style={{ width: '28rem', maxWidth: '95vw' }}
